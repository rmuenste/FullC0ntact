...
void initsimulation()
{
  ...
  myPipeline.init(&myWorld,myParameters.solverType_,myParameters.m_iMaxIterations,myParameters.pipelineIterations_);
...
void continuesimulation()
{
  ...
  //initialize the collision pipeline 
  myPipeline.init(&myWorld,myParameters.m_iMaxIterations,myParameters.pipelineIterations_);
