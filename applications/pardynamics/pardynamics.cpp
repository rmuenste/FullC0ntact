...
//     if(myWorld.rigidBodies_[j]->shape_ == RigidBody::SUBDOMAIN)
//     {
//       myWorld.subBoundary_ = dynamic_cast<SubdomainBoundary*>(myWorld.rigidBodies_[j]);
//     }
//   }
// 
//   myWorld.parInfo_.SetID(myid);
// 
//   //set the timestep
...
//   myPipeline.init(&myWorld,myParameters.solverType_,myParameters.maxIterations_,myParameters.m_iPipelineIterations);
// 
...
// 
//   //initialize the collision pipeline 
//   myPipeline.init(&myWorld,myParameters.maxIterations_,myParameters.m_iPipelineIterations);
// 
//   //set the broad phase to simple spatialhashing
//   myPipeline.setBroadPhaseHSpatialHash();
