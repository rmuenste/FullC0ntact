...
template <typename T>
CDistanceLineLine<T>::CDistanceLineLine(const CLine3<T> &Line0, const CLine3<T> &Line1) : m_Line0(Line0), m_Line1(Line1)
{
...
{
	CVector3<T> diff = m_Line0.m_vOrigin - m_Line1.m_vOrigin;
	T a01 = -m_Line0.m_vDir * m_Line1.m_vDir;
	T b0 = diff * m_Line0.m_vDir;
	T c = diff * diff;
	...
	m_vClosestPoint0 = m_Line0.m_vOrigin + m_Line0.m_vDir * s0;
	m_vClosestPoint1 = m_Line1.m_vOrigin + m_Line1.m_vDir * s1;
