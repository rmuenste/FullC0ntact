...
void CColliderBoxPlane::Collide(CRigidBody *pBody0, CRigidBody *pBody1, std::vector<CContact> &vContacts, Real dDeltaT)
{
...
void CColliderBoxPlane::Collide(std::vector<CContact> &vContacts, Real dDeltaT)
{
