...
IF(FC_BUILD_ID STREQUAL "xeon-linux-gcc-release")
  # set the compiler
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -O3 -std=c++14 -msse -msse2 -mfpmath=sse -ffast-math -Wall")
...
IF(FC_BUILD_ID STREQUAL "nehalem-linux-gcc-release")
  # set the compiler
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -O3 -std=c++14 -msse -msse2 -mfpmath=sse -ffast-math")
  SET(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -O3 -msse -msse2 -mfpmath=sse -ffast-math")
  SET(FC_BUILD_ID_FOUND true)
...
IF(FC_BUILD_ID STREQUAL "generic-linux-gcc-release")
  # set the compiler
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -O3 -std=c++14 -Wall")
...
IF(FC_BUILD_ID STREQUAL "phenomIIx4-linux-gcc-release")
  # set the compiler
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -O3 -std=c++14 -funroll-loops")
...
IF(FC_BUILD_ID STREQUAL "opteronx2-linux-gcc-release")
  ...
  SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -O3 -std=c++14 -m64 -mmmx -msse -msse2 -m3dnow -mfpmath=sse -ffast-math")
